    ...
    def clean(self):
        ...
        if role == 'customer':
            ...
            if not cleaned_data.get('company_name'):
                self.add_error('company_name', 'Company name is required for customers.')
            ...
            if customer_number:
                if User.objects.filter(customer_number=customer_number).exists():
                    self.add_error('customer_number', 'This customer number is already in use.')
...
class UserEditForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'role', 'company_name', 'phone', 'customer_number',
            'tax_id', 'is_active', 'allowed_asset_categories'
        ]
        widgets = {
            ...
            'allowed_asset_categories': forms.SelectMultiple(attrs={
                'class': 'form-select',
                'size': '6'
            }),
        }
...
class CustomerProfileForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            'business_type', 'annual_revenue', 'preferred_payment_terms',
            'credit_limit'
        ]
        widgets = {
            ...
            'preferred_payment_terms': forms.TextInput(attrs={
                'class': 'form-input',
