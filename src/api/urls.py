...
urlpatterns = [
    ...
    path(
        "products/<int:pk>/fitment/",
        views.ProductFitmentAPIView.as_view(),
        name="product_fitment",
    ),
    path(
        "products/<int:pk>/pricing/",
        views.CustomerPricingAPIView.as_view(),
    ...
    path(
        "assets/<int:pk>/download/",
        views.AssetDownloadAPIView.as_view(),
        name="asset_download",
    ),
    path("assets/search/", views.AssetSearchView.as_view(), name="asset_search"),
    # Feed endpoints
    path(
        "feeds/<int:pk>/generate/",
        views.GenerateFeedAPIView.as_view(),
        name="generate_feed",
    ),
    path(
        "feeds/<int:pk>/status/", views.FeedStatusAPIView.as_view(), name="feed_status"
    ),
    path(
        "feeds/download/<uuid:generation_id>/",
        views.FeedDownloadAPIView.as_view(),
        name="feed_download",
    ),
    ...
    path(
        ...
        views.ProductUpdateWebhook.as_view(),
        name="product_webhook",
    ),
    path(
        "webhooks/inventory-update/",
        views.InventoryUpdateWebhook.as_view(),
        name="inventory_webhook",
    ),
]
