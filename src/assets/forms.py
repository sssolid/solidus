...
class AssetForm(forms.ModelForm):
    ...
    class Meta:
        model = Asset
        fields = [
            'title', 'description', 'asset_type', 'file', 'categories',
            'is_active', 'is_public', 'copyright_info', 'alt_text',
            'caption', 'tags'
        ]
        widgets = {
            ...
            'copyright_info': forms.TextInput(attrs={
                'class': 'form-input',
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['categories'].queryset = AssetCategory.objects.filter(is_active=True)
...
class ProductAssetForm(forms.ModelForm):
    ...
    class Meta:
        model = ProductAsset
        fields = [
            'product', 'asset', 'asset_type', 'is_primary',
        ...
        widgets = {
            ...
            'asset': forms.Select(attrs={
                'class': 'form-select',
                'data-placeholder': 'Select an asset'
            }),
            'asset_type': forms.Select(attrs={'class': 'form-select'}),
...
class AssetCategoryForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_active', 'sort_order', 'requires_permission', 'allowed_roles'
        ]
        widgets = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance.pk:
            ...
            self.fields['parent'].queryset = AssetCategory.objects.filter(is_active=True)
...
class AssetCollectionForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            'name', 'slug', 'description', 'assets', 'is_public',
            'allowed_users', 'cover_image'
        ]
        widgets = {
            'name': forms.TextInput(attrs={
                'class': 'form-input',
