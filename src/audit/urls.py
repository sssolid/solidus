...
urlpatterns = [
    ...
    # Model history
    path('history/<str:app_label>/<str:model_name>/<int:object_id>/',
         views.ModelHistoryView.as_view(), name='model_history'),
    ...
    path('snapshots/<int:pk>/restore/', views.restore_snapshot, name='restore_snapshot'),
    path('snapshots/<int:pk>/compare/', views.compare_snapshots, name='compare_snapshots'),

    # Bulk operations
    path('bulk-operations/', views.BulkOperationListView.as_view(), name='bulk_operation_list'),
    path('bulk-operations/<str:operation_id>/', views.BulkOperationDetailView.as_view(), name='bulk_operation_detail'),

    # Reports
    path('reports/', views.AuditReportsView.as_view(), name='reports'),
    path('reports/user-activity/', views.UserActivityReportView.as_view(), name='user_activity_report'),
