...
class ACESCodedValue(models.Model):
    """ACES coded values for standardized automotive data"""
    element = models.CharField(max_length=255, null=True, blank=True, verbose_name="Element")
    attribute = models.CharField(max_length=255, null=True, blank=True, verbose_name="Attribute")
    coded_value = models.CharField(max_length=255, null=True, blank=True, verbose_name="Coded Value")
    code_description = models.CharField(max_length=255, null=True, blank=True, verbose_name="Code Description")

    class Meta:
        db_table = 'aces_coded_values'
...
class Alias(models.Model):
    ...
    alias_id = models.AutoField(primary_key=True, verbose_name="Alias ID")
...
class Subcategory(models.Model):
    ...
    sub_category_id = models.AutoField(primary_key=True, verbose_name="Subcategory ID")
    sub_category_name = models.CharField(max_length=100, verbose_name="Subcategory Name")
...
class Position(models.Model):
    """Part positions"""
    position_id = models.AutoField(primary_key=True, verbose_name="Position ID")
...
class Use(models.Model):
    ...
    use_id = models.AutoField(primary_key=True, verbose_name="Use ID")
    use_description = models.CharField(max_length=100, verbose_name="Use Description")
...
class PartsDescription(models.Model):
    ...
    parts_description_id = models.AutoField(primary_key=True, verbose_name="Parts Description ID")
    parts_description = models.CharField(max_length=500, verbose_name="Parts Description")
...
class Part(models.Model):
    ...
    part_terminology_id = models.AutoField(primary_key=True, verbose_name="Part Terminology ID")
    part_terminology_name = models.CharField(max_length=256, verbose_name="Part Terminology Name")
    ...
    rev_date = models.DateField(null=True, blank=True, verbose_name="Revision Date")
...
class MeasurementGroup(models.Model):
    ...
    measurement_group_id = models.AutoField(primary_key=True, verbose_name="Measurement Group ID")
    measurement_group_name = models.CharField(max_length=80, null=True, blank=True, verbose_name="Measurement Group Name")
...
class MetaData(models.Model):
    ...
    meta_id = models.AutoField(primary_key=True, verbose_name="Meta ID")
    meta_name = models.CharField(max_length=80, null=True, blank=True, verbose_name="Meta Name")
    meta_description = models.CharField(max_length=512, null=True, blank=True, verbose_name="Meta Description")
    meta_format = models.CharField(max_length=10, null=True, blank=True, verbose_name="Meta Format")
    data_type = models.CharField(max_length=50, null=True, blank=True, verbose_name="Data Type")
    min_length = models.IntegerField(null=True, blank=True, verbose_name="Minimum Length")
    max_length = models.IntegerField(null=True, blank=True, verbose_name="Maximum Length")
...
class MetaUOMCode(models.Model):
    ...
    meta_uom_id = models.AutoField(primary_key=True, verbose_name="Meta UOM ID")
    uom_code = models.CharField(max_length=10, null=True, blank=True, verbose_name="UOM Code")
    uom_description = models.CharField(max_length=512, null=True, blank=True, verbose_name="UOM Description")
    uom_label = models.CharField(max_length=10, null=True, blank=True, verbose_name="UOM Label")
...
class PartAttribute(models.Model):
    ...
    pa_id = models.AutoField(primary_key=True, verbose_name="Part Attribute ID")
    pa_name = models.CharField(max_length=80, null=True, blank=True, verbose_name="Attribute Name")
    pa_description = models.CharField(max_length=512, null=True, blank=True, verbose_name="Attribute Description")

    class Meta:
        db_table = 'part_attributes'
...
class PartAttributeAssignment(models.Model):
    ...
    papt_id = models.AutoField(primary_key=True, verbose_name="Part Attribute Assignment ID")
    meta_data = models.ForeignKey(MetaData, on_delete=models.CASCADE, verbose_name="Meta Data")
    part = models.ForeignKey(Part, on_delete=models.CASCADE, verbose_name="Part")
    part_attribute = models.ForeignKey(PartAttribute, on_delete=models.CASCADE, verbose_name="Part Attribute")

    class Meta:
        db_table = 'part_attribute_assignment'
...
class MetaUOMCodeAssignment(models.Model):
    ...
    meta_uom_code_assignment_id = models.AutoField(primary_key=True, verbose_name="Meta UOM Code Assignment ID")
    part_attribute_assignment = models.ForeignKey(
        PartAttributeAssignment,
        on_delete=models.CASCADE,
        verbose_name="Part Attribute Assignment"
    )
    meta_uom = models.ForeignKey(MetaUOMCode, on_delete=models.CASCADE, verbose_name="Meta UOM")

    class Meta:
        db_table = 'meta_uom_code_assignment'
...
class PartPosition(models.Model):
    """Part positions"""
    part_position_id = models.AutoField(primary_key=True, verbose_name="Part Position ID")
    part = models.ForeignKey(Part, on_delete=models.CASCADE, verbose_name="Part")
    position = models.ForeignKey(Position, on_delete=models.CASCADE, verbose_name="Position")
    rev_date = models.DateField(null=True, blank=True, verbose_name="Revision Date")

    class Meta:
        db_table = 'part_position'
...
class PartCategory(models.Model):
    ...
    part_category_id = models.AutoField(primary_key=True, verbose_name="Part Category ID")
    part = models.ForeignKey(Part, on_delete=models.CASCADE, verbose_name="Part")
...
class PartsToAlias(models.Model):
    ...
    part = models.ForeignKey(Part, on_delete=models.CASCADE, verbose_name="Part")
    alias = models.ForeignKey(Alias, on_delete=models.CASCADE, verbose_name="Alias")

    class Meta:
        db_table = 'parts_to_alias'
...
class PartsToUse(models.Model):
    ...
    part = models.ForeignKey(Part, on_delete=models.CASCADE, verbose_name="Part")
    use = models.ForeignKey(Use, on_delete=models.CASCADE, verbose_name="Use")

    class Meta:
        db_table = 'parts_to_use'
...
class PartsSupersession(models.Model):
    ...
    parts_supersession_id = models.AutoField(primary_key=True, verbose_name="Parts Supersession ID")
    old_part_terminology_id = models.IntegerField(verbose_name="Old Part Terminology ID")
    old_part_terminology_name = models.CharField(max_length=256, verbose_name="Old Part Terminology Name")
    new_part_terminology_id = models.IntegerField(verbose_name="New Part Terminology ID")
    new_part_terminology_name = models.CharField(max_length=256, verbose_name="New Part Terminology Name")
    rev_date = models.DateField(null=True, blank=True, verbose_name="Revision Date")
    note = models.CharField(max_length=1000, null=True, blank=True, verbose_name="Note")

    class Meta:
        db_table = 'parts_supersession'
...
class ValidValue(models.Model):
    ...
    valid_value_id = models.AutoField(primary_key=True, verbose_name="Valid Value ID")
    valid_value = models.CharField(max_length=100, verbose_name="Valid Value")

    class Meta:
        db_table = 'valid_values'
...
class ValidValueAssignment(models.Model):
    ...
    valid_value_assignment_id = models.AutoField(primary_key=True, verbose_name="Valid Value Assignment ID")
    part_attribute_assignment = models.ForeignKey(
        PartAttributeAssignment,
        on_delete=models.CASCADE,
        verbose_name="Part Attribute Assignment"
    )
    valid_value = models.ForeignKey(ValidValue, on_delete=models.CASCADE, verbose_name="Valid Value")

    class Meta:
        db_table = 'valid_value_assignment'
...
class PIESSegment(models.Model):
    """PIES segments"""
    pies_segment_id = models.AutoField(primary_key=True, verbose_name="PIES Segment ID")
    segment_abb = models.CharField(max_length=50, verbose_name="Segment Abbreviation")
    segment_name = models.CharField(max_length=50, verbose_name="Segment Name")
    segment_description = models.CharField(max_length=250, verbose_name="Segment Description")

    class Meta:
        db_table = 'pies_segment'
...
class PIESCode(models.Model):
    """PIES codes"""
    pies_code_id = models.AutoField(primary_key=True, verbose_name="PIES Code ID")
    code_value = models.CharField(max_length=255, verbose_name="Code Value")
    code_format = models.CharField(max_length=255, verbose_name="Code Format")
    field_format = models.CharField(max_length=255, null=True, blank=True, verbose_name="Field Format")
    code_description = models.CharField(max_length=255, verbose_name="Code Description")
...
class PIESExpiGroup(models.Model):
    ...
    pies_expi_group_id = models.AutoField(primary_key=True, verbose_name="PIES Expi Group ID")
    expi_group_code = models.CharField(max_length=255, verbose_name="Expi Group Code")
    expi_group_description = models.CharField(max_length=255, verbose_name="Expi Group Description")

    class Meta:
        db_table = 'pies_expi_group'
...
class PIESExpiCode(models.Model):
    ...
    pies_expi_code_id = models.AutoField(primary_key=True, verbose_name="PIES Expi Code ID")
    expi_code = models.CharField(max_length=50, verbose_name="Expi Code")
    expi_code_description = models.CharField(max_length=255, verbose_name="Expi Code Description")
...
class PIESField(models.Model):
    """PIES fields"""
    pies_field_id = models.AutoField(primary_key=True, verbose_name="PIES Field ID")
    field_name = models.CharField(max_length=255, verbose_name="Field Name")
    reference_field_number = models.CharField(max_length=255, verbose_name="Reference Field Number")
    pies_segment = models.ForeignKey(PIESSegment, on_delete=models.CASCADE, verbose_name="PIES Segment")
...
class PIESReferenceFieldCode(models.Model):
    ...
    pies_reference_field_code_id = models.AutoField(primary_key=True, verbose_name="PIES Reference Field Code ID")
    pies_field = models.ForeignKey(PIESField, on_delete=models.CASCADE, verbose_name="PIES Field")
    pies_code = models.ForeignKey(PIESCode, on_delete=models.CASCADE, verbose_name="PIES Code")
    ...
    reference_notes = models.CharField(max_length=2000, null=True, blank=True, verbose_name="Reference Notes")

    class Meta:
        db_table = 'pies_reference_field_code'
...
class ChangeReason(models.Model):
    """Reasons for changes"""
    change_reason_id = models.AutoField(primary_key=True, verbose_name="Change Reason ID")
    change_reason = models.CharField(max_length=255, verbose_name="Change Reason")

    class Meta:
        db_table = 'change_reasons'
...
class ChangeTableName(models.Model):
    """Table names for change tracking"""
    table_name_id = models.AutoField(primary_key=True, verbose_name="Table Name ID")
    table_name = models.CharField(max_length=255, verbose_name="Table Name")
    table_description = models.CharField(max_length=1000, null=True, blank=True, verbose_name="Table Description")

    class Meta:
        db_table = 'change_table_names'
...
class ChangeAttributeState(models.Model):
    """States for change attributes"""
    change_attribute_state_id = models.AutoField(primary_key=True, verbose_name="Change Attribute State ID")
    change_attribute_state = models.CharField(max_length=255, verbose_name="Change Attribute State")

    class Meta:
        db_table = 'change_attribute_states'
...
class Change(models.Model):
    ...
    change_id = models.AutoField(primary_key=True, verbose_name="Change ID")
    request_id = models.IntegerField(verbose_name="Request ID")
    change_reason = models.ForeignKey(ChangeReason, on_delete=models.CASCADE, verbose_name="Change Reason")
    rev_date = models.DateField(null=True, blank=True, verbose_name="Revision Date")
...
class ChangeDetail(models.Model):
    ...
    change_detail_id = models.AutoField(primary_key=True, verbose_name="Change Detail ID")
    change = models.ForeignKey(Change, on_delete=models.CASCADE, verbose_name="Change")
    change_attribute_state = models.ForeignKey(
        ChangeAttributeState,
        on_delete=models.CASCADE,
        verbose_name="Change Attribute State"
    )
    table_name = models.ForeignKey(ChangeTableName, on_delete=models.CASCADE, verbose_name="Table Name")
    primary_key_column_name = models.CharField(max_length=255, null=True, blank=True, verbose_name="Primary Key Column Name")
    primary_key_before = models.IntegerField(null=True, blank=True, verbose_name="Primary Key Before")
    primary_key_after = models.IntegerField(null=True, blank=True, verbose_name="Primary Key After")
    column_name = models.CharField(max_length=255, null=True, blank=True, verbose_name="Column Name")
    column_value_before = models.CharField(max_length=1000, null=True, blank=True, verbose_name="Column Value Before")
    column_value_after = models.CharField(max_length=1000, null=True, blank=True, verbose_name="Column Value After")
...
class Style(models.Model):
    """Styling information"""
    style_id = models.AutoField(primary_key=True, verbose_name="Style ID")
    style_name = models.CharField(max_length=80, null=True, blank=True, verbose_name="Style Name")
...
class PartAttributeStyle(models.Model):
    ...
    style = models.ForeignKey(Style, on_delete=models.CASCADE, null=True, blank=True, verbose_name="Style")
    part_attribute_assignment = models.ForeignKey(
        PartAttributeAssignment,
        on_delete=models.CASCADE,
        null=True,
...
class PartTypeStyle(models.Model):
    ...
    style = models.ForeignKey(Style, on_delete=models.CASCADE, null=True, blank=True, verbose_name="Style")
    part = models.ForeignKey(Part, on_delete=models.CASCADE, null=True, blank=True, verbose_name="Part")

    class Meta:
        db_table = 'part_type_style'
...
class CodeMaster(models.Model):
    ...
    code_master_id = models.AutoField(primary_key=True, verbose_name="Code Master ID")
    part = models.ForeignKey(Part, on_delete=models.CASCADE, verbose_name="Part")
    category = models.ForeignKey(Category, on_delete=models.CASCADE, verbose_name="Category")
    subcategory = models.ForeignKey(Subcategory, on_delete=models.CASCADE, verbose_name="Subcategory")
    position = models.ForeignKey(Position, on_delete=models.CASCADE, verbose_name="Position")
...
class PCdbChange(models.Model):
    """PCdb change tracking"""
    id = models.AutoField(primary_key=True)
    code_master_id = models.IntegerField(null=True, blank=True, verbose_name="Code Master ID")
    category_id = models.IntegerField(null=True, blank=True, verbose_name="Category ID")
    category_name = models.CharField(max_length=100, null=True, blank=True, verbose_name="Category Name")
    sub_category_id = models.IntegerField(null=True, blank=True, verbose_name="Sub Category ID")
    sub_category_name = models.CharField(max_length=100, null=True, blank=True, verbose_name="Sub Category Name")
    part_terminology_id = models.IntegerField(null=True, blank=True, verbose_name="Part Terminology ID")
    part_terminology_name = models.CharField(max_length=100, null=True, blank=True, verbose_name="Part Terminology Name")
    use_id = models.IntegerField(null=True, blank=True, verbose_name="Use ID")
    use_description = models.CharField(max_length=100, null=True, blank=True, verbose_name="Use Description")
    position_id = models.IntegerField(null=True, blank=True, verbose_name="Position ID")
    position = models.CharField(max_length=100, null=True, blank=True, verbose_name="Position")
    rev_date = models.DateField(null=True, blank=True, verbose_name="Revision Date")
    action = models.CharField(max_length=20, null=True, blank=True, verbose_name="Action")

    class Meta:
        db_table = 'pcdb_changes'
...
class RetiredTerm(models.Model):
    """Retired terminology tracking"""
    id = models.AutoField(primary_key=True)
    part_name = models.CharField(max_length=255, null=True, blank=True, verbose_name="Part Name")
    part_id_code = models.IntegerField(null=True, blank=True, verbose_name="Part ID Code")

    class Meta:
        db_table = 'retired_terms'
...
class Version(models.Model):
    """Version tracking"""
    id = models.AutoField(primary_key=True)
    version_date = models.DateField(null=True, blank=True, verbose_name="Version Date")
