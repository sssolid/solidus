...
class DataFeedForm(forms.ModelForm):
    ...
    class Meta:
        model = DataFeed
        fields = [
            'name', 'description', 'feed_type', 'format', 'customer',
            'categories', 'brands', 'product_tags', 'include_inactive',
            'include_images', 'include_fitment', 'include_pricing',
            'field_mapping', 'custom_fields', 'is_active'
        ]
        widgets = {
            ...
            'product_tags': forms.TextInput(attrs={
                'class': 'form-input',
...
class SubscriptionForm(forms.ModelForm):
    ...
    class Meta:
        model = Subscription
        fields = [
            'feed', 'customer', 'schedule_type', 'schedule_config',
...
class DeliveryConfigForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            'feed', 'delivery_method', 'config', 'is_active'
        ]
        widgets = {
            'feed': forms.Select(attrs={'class': 'form-select'}),
