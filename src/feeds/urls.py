...
urlpatterns = [
    ...
    # Subscriptions
    path(
        "subscriptions/", views.SubscriptionListView.as_view(), name="subscription_list"
    ),
    path(
    ...
    path(
        ...
        views.SubscriptionEditView.as_view(),
    ...
    path(
        "<int:pk>/delivery/", views.DeliveryConfigView.as_view(), name="delivery_config"
    ),
