...
class ProductForm(forms.ModelForm):
    ...
    class Meta:
        model = Product
        fields = [
            'sku', 'name', 'description', 'brand', 'categories',
            'weight', 'dimensions', 'material', 'color', 'finish',
            'part_numbers', 'oem_numbers', 'msrp', 'map_price',
            'is_active', 'is_featured', 'launch_date', 'discontinue_date',
        ...
        widgets = {
            ...
            'part_numbers': forms.Textarea(attrs={
                'class': 'form-textarea',
                'rows': 3,
                'placeholder': 'One part number per line'
            }),
            'oem_numbers': forms.Textarea(attrs={
                'class': 'form-textarea',
                'rows': 3,
                'placeholder': 'One OEM number per line'
            }),
            'msrp': forms.NumberInput(attrs={
                'class': 'form-input',
                'placeholder': '0.00',
                'step': '0.01'
            }),
            'map_price': forms.NumberInput(attrs={
                'class': 'form-input',
                'placeholder': '0.00',
                'step': '0.01'
            }),
            ...
            'discontinue_date': forms.DateInput(attrs={
                'class': 'form-input',
                'type': 'date'
            }),
...
class ProductFitmentForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'submodel': forms.TextInput(attrs={
                'class': 'form-input',
                'placeholder': 'e.g., SuperCrew'
            }),
